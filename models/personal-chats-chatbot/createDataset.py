...
def getFacebookData():
	...
	fbFile = codecs.open('fbMessages.txt', 'r', 'utf-16') 
	...
	for index,lines in enumerate(allLines):
		...
		# Find messages that I sent
		# print(justMessage[:colon], personName)
...
conversationFile = codecs.open('conversationData.txt', 'w', 'utf-16')
